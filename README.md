...
<resources>
    ...
    <color name="backgroundColor">#5B198F</color>
    <color name="cardColor">#AF17A4</color>
    <color name="textColor">#000000</color>
    <color name="textBackground">#ffffff</color>
    <color name="orchidColor">#E161DC</color>
---
```
    <!-- System -->
    <color name="infoBlueColor">#2f70e1</color>
    <color name="successColor">#53d76a</color>
    <color name="warningColor">#ddaa3b</color>
    <color name="dangerColor">#e5000f</color>
